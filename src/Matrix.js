...
export default class Matrix extends Component {
    ...
    genRow = (vals) => (
            ...
            genMatrix = () => (
                ...
                render() {
                    return ( <
                        div id = "app" > { /* ColorSelector is the interface where users will be able to select a color, so it will need access to setSelectedColor. We can pass the needed function down as a prop */ } <
